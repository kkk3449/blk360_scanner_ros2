...
#define BLK360_LIBRARY_VERSION 0x07020404
...
typedef struct { Blk360_Handle handle; } Blk360_PointCloudColorChunkHandle;
typedef struct { Blk360_Handle handle; } Blk360_StitchedPanoramaHandle;
typedef struct { Blk360_Handle handle; } Blk360_FieldCalibrationWorkflowHandle;
typedef struct { Blk360_Handle handle; } Blk360_PointCloudColorizerHandle;
...
typedef enum
{
    Blk360_CancelledDownload_PointCloud = 1,
    Blk360_CancelledDownload_ColorPanorama = 2,
    Blk360_CancelledDownload_IRPanorama = 3
} Blk360_CancelledDownload;
...
typedef enum
{
    Blk360_FlashMode_Auto = 0,
    Blk360_FlashMode_On = 1,
    Blk360_FlashMode_Off = 2
} Blk360_FlashMode;
...
typedef enum
{
    Blk360_PointCloudAllocator_Preallocated = 0,
    Blk360_PointCloudAllocator_Dynamic = 1
} Blk360_PointCloudAllocator;

typedef struct
{
    float clippingValue; // the value can be in range [0.0; 5.0f]
    double toneMappingGamma; // the value can be in range (0.0; 5.0]
    uint64_t singlePointCloudMemoryLimit; //in MB
    Blk360_PointCloudAllocator allocator;
    bool autoRemoveHDRComponents;
...
typedef enum
{
    ...
    BLK360_Error_FieldCalibrationScanAcquisitionError = 10,
    BLK360_Error_FieldCalibrationProcessingError = 11,
    BLK360_Error_FieldCalibrationVerificationError = 12,
    BLK360_Error_UnimplementedFunction = 13,
    BLK360_Error_DeviceOccupied = 14,            // Device is occupied by another user
} Blk360_ErrorCode;
...
typedef struct
{
    bool distanceImprovable;
    bool elevationImprovable;
    bool wallSuggested;
    bool chairSuggested;
} Blk360_EnvironmentImprovements;

typedef enum
{
    Blk360_FieldCalibrationQuality_Undefined,
    Blk360_FieldCalibrationQuality_InSpec,
    Blk360_FieldCalibrationQuality_CloseToSpec,
    Blk360_FieldCalibrationQuality_OutOfSpec
} Blk360_FieldCalibrationQuality;

typedef struct
{
    Blk360_EnvironmentImprovements hints;
    Blk360_FieldCalibrationQuality quality;
    Blk360_percent_t environmentRating;
} Blk360_FieldCalibrationResult;

typedef enum
{
    Blk360_FieldCalibrationStep_ScanAcquisition,
    Blk360_FieldCalibrationStep_DataProcessing,
    Blk360_FieldCalibrationStep_Verification,
    Blk360_FieldCalibrationStep_ResultReady
} Blk360_FieldCalibrationStep;

typedef struct
{
    Blk360_SubscriptionHandle sender;
    Blk360_FieldCalibrationStep step;
    Blk360_percent_t stepProgress;
} Blk360_FieldCalibrationProgressEvent;
...
typedef struct
{
    ...
    uint64_t totalSize;
} Blk360_PointCloudDownloadProgressEvent;
...
typedef struct
{
    ...
    Blk360_CancelledDownload cancelledAction;
} Blk360_DownloadCancelEvent;

typedef struct
{
    Blk360_SubscriptionHandle sender;
    Blk360_percent_t progress;
} Blk360_PointCloudColorizerPanoramaProgressEvent;
...
BLK360_SHARED void Blk360_ImageEnumerator_Release(Blk360_ImageEnumeratorHandle instance);
...
BLK360_SHARED void Blk360_IrImageEnumerator_Release(Blk360_IrImageEnumeratorHandle instance);
...
BLK360_SHARED const char* Blk360_Measurement_GetName(Blk360_MeasurementHandle measurement);
...
BLK360_SHARED void Blk360_Image_Release(Blk360_ImageHandle image);
...
BLK360_SHARED void Blk360_IrImage_Release(Blk360_IrImageHandle irImage);

BLK360_SHARED uint32_t Blk360_PointCloud_GetChunksLimit(Blk360_PointCloudHandle pointcloud);
...
BLK360_SHARED void Blk360_PointCloud_Release(Blk360_PointCloudHandle handle);
BLK360_SHARED Blk360_PointCloudChunkEnumeratorHandle Blk360_PointCloud_GetChunks(Blk360_PointCloudHandle handle);
BLK360_SHARED void Blk360_PointCloudChunk_Release(Blk360_PointCloudChunkHandle handle);
...
BLK360_SHARED const char* Blk360_PointCloudColorChunk_GetData(Blk360_PointCloudColorChunkHandle handle);
BLK360_SHARED uint64_t Blk360_PointCloudColorChunk_GetDataSizeInBytes(Blk360_PointCloudColorChunkHandle handle);
BLK360_SHARED void Blk360_PointCloudColorChunk_Release(Blk360_PointCloudColorChunkHandle handle);
...
BLK360_SHARED void Blk360_SystemWorkflow_SetMeasurementNameTemplate(Blk360_SystemWorkflowHandle instance, const char* nameTemplate);
BLK360_SHARED const char* Blk360_SystemWorkflow_GetMeasurementNameTemplate(Blk360_SystemWorkflowHandle instance);
...
BLK360_SHARED void Blk360_DataManipulationWorkflow_RefreshMeasurement(Blk360_DataManipulationWorkflowHandle instance, Blk360_MeasurementHandle measurement);
BLK360_SHARED void Blk360_DataManipulationWorkflow_Measurement_SetName(Blk360_DataManipulationWorkflowHandle instance, Blk360_MeasurementHandle measurement, const char* name);
...
BLK360_SHARED Blk360_SubscriptionHandle Blk360_DataManipulationWorkflow_OnPointCloudDownloadProgress(Blk360_DataManipulationWorkflowHandle instance, Blk360_EventQueueHandle queue);
...
BLK360_SHARED Blk360_SubscriptionHandle Blk360_DataManipulationWorkflow_OnCancelled(Blk360_DataManipulationWorkflowHandle instance, Blk360_EventQueueHandle queue);
...
/****************** PointCloudColorizer ************************/
BLK360_SHARED Blk360_PointCloudColorizerHandle Blk360_PointCloudColorizer_New(uint32_t resolution);
BLK360_SHARED void Blk360_PointCloudColorizer_Release(Blk360_PointCloudColorizerHandle instance);
BLK360_SHARED bool Blk360_PointCloudColorizer_IsReady(Blk360_PointCloudColorizerHandle instance);
...
BLK360_SHARED void Blk360_ProcessingWorkflow_ToneMapHDRImage(Blk360_ProcessingWorkflowHandle instance, Blk360_ImageHandle image);
...
BLK360_SHARED void Blk360_ProcessingWorkflow_PointCloudColorizer_Initialize(Blk360_ProcessingWorkflowHandle instance, Blk360_PointCloudColorizerHandle colorizer, Blk360_MeasurementHandle measurement);
BLK360_SHARED void Blk360_ProcessingWorkflow_PointCloudColorizer_AddImage(Blk360_ProcessingWorkflowHandle instance, Blk360_PointCloudColorizerHandle colorizer, Blk360_ImageHandle image);
BLK360_SHARED void Blk360_ProcessingWorkflow_PointCloudColorizer_AddPanorama(Blk360_ProcessingWorkflowHandle instance, Blk360_PointCloudColorizerHandle colorizer, Blk360_ImageEnumeratorHandle images);
BLK360_SHARED Blk360_PointCloudColorChunkHandle Blk360_ProcessingWorkflow_PointCloudColorizer_Colorize(Blk360_ProcessingWorkflowHandle instance, Blk360_PointCloudColorizerHandle colorizer, Blk360_PointCloudChunkHandle chunk);
...
BLK360_SHARED Blk360_SubscriptionHandle Blk360_ProcessingWorkflow_OnPointCloudColorizerPanoramaProgress(Blk360_ProcessingWorkflowHandle instance, Blk360_EventQueueHandle queue);
BLK360_SHARED Blk360_SubscriptionHandle Blk360_ProcessingWorkflow_OnPointCloudColorizerPanoramaError(Blk360_ProcessingWorkflowHandle instance, Blk360_EventQueueHandle queue);
...
/****************** FieldCalibrationWorkflow ************************/
BLK360_SHARED Blk360_FieldCalibrationWorkflowHandle Blk360_FieldCalibrationWorkflow_Create(Blk360_SessionHandle session);
BLK360_SHARED void Blk360_FieldCalibrationWorkflow_Release(Blk360_FieldCalibrationWorkflowHandle instance);
BLK360_SHARED void Blk360_FieldCalibrationWorkflow_Start(Blk360_FieldCalibrationWorkflowHandle instance);
BLK360_SHARED void Blk360_FieldCalibrationWorkflow_Cancel(Blk360_FieldCalibrationWorkflowHandle instance);
BLK360_SHARED Blk360_SubscriptionHandle Blk360_FieldCalibrationWorkflow_OnProgress(Blk360_FieldCalibrationWorkflowHandle instance, Blk360_EventQueueHandle queue);
BLK360_SHARED Blk360_SubscriptionHandle Blk360_FieldCalibrationWorkflow_OnError(Blk360_FieldCalibrationWorkflowHandle instance, Blk360_EventQueueHandle queue);
BLK360_SHARED Blk360_SubscriptionHandle Blk360_FieldCalibrationWorkflow_OnCancelled(Blk360_FieldCalibrationWorkflowHandle instance, Blk360_EventQueueHandle queue);
BLK360_SHARED Blk360_FieldCalibrationResult Blk360_FieldCalibrationWorkflow_GetFieldCalibrationResult(Blk360_FieldCalibrationWorkflowHandle instance);
BLK360_SHARED void Blk360_FieldCalibrationWorkflow_SetServiceFilePath(Blk360_FieldCalibrationWorkflowHandle instance, const char* outputPath);
BLK360_SHARED bool Blk360_FieldCalibrationWorkflow_GetSavingServiceFileResult(Blk360_FieldCalibrationWorkflowHandle instance);
