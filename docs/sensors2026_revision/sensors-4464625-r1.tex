...
transfer directly to this stop-and-scan workflow. The method developed in this
...
grid~\cite{elfes1989,thrun2005} $\mathcal{M}$ produced online by simultaneous
localization and mapping (SLAM), following the \texttt{nav\_msgs/OccupancyGrid}
...
stationary sensor (Figure~\ref{fig:redbot}).
...
3D surface coverage (Section~\ref{sec:scope2d}). Extending the model to a
