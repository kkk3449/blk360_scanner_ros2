...
extraction~\cite{fischler1981ransac}:
...
quantified in Sec.~\ref{sec:exp-seg}.
...
keyboards or handrails, Sec.~\ref{sec:exp-verify}). We therefore filter any cluster that is (i) a thin vertical planar
...
ablation (Sec.~\ref{sec:exp-ablation}) shows that narrowing the vocabulary to the deployment
...
type and a \emph{vote share}. Three outcomes follow
...
measurement, Sec.~\ref{sec:exp-update}). Fig.~\ref{fig:upsert} summarizes
