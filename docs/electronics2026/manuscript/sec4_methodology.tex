...
objects (named stars). Owner-refuted phantoms (a verified keyboard,
staircase, and fire extinguisher that do not exist in the room) are
crossed out and excluded from key-object designation.}
\label{fig:relmap}
\end{figure}
