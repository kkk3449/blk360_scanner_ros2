...
re-split gates with the structure-condition ensemble, and the
owner-evidence revision path---are introduced in
Sec.~\ref{sec:experiments} alongside the failures that motivated them
