...
of the cluster. A provisional semantic label is then attached by Uni3D
...
(trigger rates 52--58\%, Sec.~5.3), and per-call cost is $\sim$\$0.009, so a
...
without visibly contradicting its input; all four traps are blocked and
hallucination drops accordingly (Sec.~5.4).
