...
\author{Sangmin Kim$^{1,2}$ \and Haryeong Kim$^{1,2}$\thanks{Authorship pending
final contribution split (Sec.~5.2 refinement study).} \and
Tae-Yong Kuc$^{1,2,*}$\\[2pt]
\small $^1$Department of Electrical and Computer Engineering, Sungkyunkwan University\\
\small $^2$CASELAB Co., Ltd. \quad $^*$Corresponding author}
...
% \bibliography{refs}   % refs.bib to be assembled at porting time
