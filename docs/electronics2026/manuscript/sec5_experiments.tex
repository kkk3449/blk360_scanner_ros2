...
chairs; at T3, a $7.4$\,m wall-side structure escalation-verified as a
staircase that the owner also refuted---and whose phantom label then
propagated into a place name (\texttt{staircase\_landing},
Sec.~\ref{sec:place}), showing that place naming is verifier-bounded too.
