...
domain-dependent. What neither lever reaches is fragmentation: the
seven sofa clusters are absorbed in all four cells
(Fig.~\ref{fig:cafe}b, bottom) and the planters stay mislabeled.
