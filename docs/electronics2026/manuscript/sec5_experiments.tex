...
\texttt{operator\_workstation}/\allowbreak\texttt{cluttered\_seating\_area}
at T3, at
\$0.02--0.03 per epoch.
...
objects). Gray shapes are unchanged furniture; each edited object is
annotated with the matcher's decision. (A)~A repeat scan with no changes
