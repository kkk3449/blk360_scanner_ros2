...
sofa fragment is recovered, and two planters regress. Render quality
repairs \emph{whole-object} ambiguity; fragmentation-induced absorption
is a segmentation problem that no verifier or render upgrade reaches
(Sonnet~5 fares no better on such inputs, above). Together with the
