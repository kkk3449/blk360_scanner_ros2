...
gate of Sec.~\ref{sec:query}), mint-once identity with history-preserving
upserts (contribution~3), the trigger-defined corrective layers
(contribution~4, Sec.~\ref{sec:corrective}), and owner feedback as
...
cumulatively (Sec.~\ref{sec:exp-endtoend}); structural gating changes
trap hallucination from 0/4 blocked (same graph, ungated) to 3--4/4
(Sec.~\ref{sec:exp-query}); escalation adds $+$11.1/$+$6.3 accuracy
points over single-pass fusion (Sec.~\ref{sec:exp-verify}); and, for context
...
maintain (Sec.~\ref{sec:exp-endtoend}).
...
refused; Sec.~\ref{sec:realrobot}). Beyond the headline gains---escalation
